...
const DoctorDashboard = () => {
  ...
  {acceptedRequests.has(request.userEmail) || request.docAccepted===true ?  (
    ...
    <>
      <button
        ...
        onClick={() => handleAccept(request.docEmail, request.userEmail)}
      >
        Accept
      </button>
            ...
            <div className="flex-1 overflow-y-auto p-5">
              <div className="space-y-6">
                <div className="flex justify-center my-4">
                  <span className="px-4 py-1 bg-blue-100 rounded-full text-sm text-blue-600">
                    Today, 10:30 AM
                  </span>
                </div>
                ...
                <div className="flex">
                  <img
                    src={selectedPatient.image}
                    alt={selectedPatient.name}
                    className="w-10 h-10 rounded-lg mr-3 self-end"
                  />
                  <div className="bg-white rounded-2xl rounded-bl-none p-4 shadow-sm max-w-md border border-blue-100">
                    <p className="text-gray-800">
                      Hello Doctor, I've been experiencing more frequent
                      headaches recently. They seem to be getting worse and
                ...
                <div className="flex justify-center">
                  <div className="bg-teal-50 rounded-2xl p-4 border border-teal-200 max-w-md shadow-sm">
                    <div className="flex items-center mb-2">
                      <div className="w-6 h-6 rounded-md bg-teal-500 text-white flex items-center justify-center mr-2 text-xs font-bold">
                        AI
                      </div>
                    ...
                    <p className="text-sm text-gray-700">
                      Consider asking about potential triggers like stress,
                      screen time, or sleep patterns. This could help identify
                      if these are tension headaches or migraines.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-end">
                  <div className="bg-teal-500 rounded-2xl rounded-tr-none p-4 text-white shadow-sm max-w-md">
                    <p>
                      I'm sorry to hear that. Have you noticed any patterns with
                      these headaches? For example, time of day, after certain
                      activities, or related to stress?
                    </p>
                    <span className="text-xs text-teal-100 mt-2 inline-block">
                      10:32 AM
                    </span>
                  </div>
                  <img
                    ...
                    alt="Doctor"
                    className="w-10 h-10 rounded-lg ml-3 self-end"
                  />
                </div>
                ...
                <div className="flex animate-fadeIn">
                  ...
                  <div className="bg-white rounded-2xl rounded-bl-none p-4 shadow-sm max-w-md border border-blue-100">
                    <p className="mb-3 text-gray-800">
                      They usually start in the afternoon after long hours on my
                      computer. This is how I feel by the end of the day:
                    </p>
          ...
          <div className="flex items-center justify-center h-full p-10">
            <div className="text-center bg-white p-10 rounded-2xl shadow-sm border border-blue-100 max-w-lg">
              ...
              <p className="text-gray-600 mb-8">
                Your AI-powered telemedicine platform. Select a patient from the
                list to start a consultation or respond to new connection
                requests.
              </p>
