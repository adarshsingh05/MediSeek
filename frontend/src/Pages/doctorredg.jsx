...
const DoctorRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/auth/doctorredg', {
        method: 'POST',
        headers: {
  ...
  if (isSubmitted) {
    ...
    return (
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        Thank you for registering with MediSeek.ai. Your profile is now under review.
        We'll notify you once it's approved and patients can start booking appointments.
        </p>
        <button 
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-6 shadow-sm">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">Connect with patients, grow your practice</p>
          </div>
        ...
        <div className="flex justify-between mb-8 relative">
          ...
          <div className="relative flex flex-col items-center z-10">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
              currentStep > 1 ? 'bg-blue-500 text-white' : currentStep === 1 ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-600'
          ...
          <div className="relative flex flex-col items-center z-10">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
              currentStep > 2 ? 'bg-blue-500 text-white' : currentStep === 2 ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-600'
            } transition-colors duration-300`}>
                ...
                <div className="space-y-8">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="font-medium">{formData.name || "Not provided"}</h4>
                          <p className="text-sm text-gray-600">{formData.specialty || "No specialty selected"}</p>
                        </div>
                      </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <h4 className="text-sm font-medium text-black mb-2">Professional Bio</h4>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-sm font-medium text-black mb-2">Available Days</h4>
                        <div className="flex flex-wrap gap-2">
                          {formData.availableDays && formData.availableDays.length > 0 ? (
                            formData.availableDays.map(day => (
                              <span key={day} className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-sm">
                                {day}
                              </span>
                            ))
                          ) : (
                            <span className="text-sm text-gray-600">No days selected</span>
                          )}
                        </div>
                      </div>
                      
                      <div>
                        <h4 className="text-sm text-black font-medium mb-2">Hours</h4>
                        <div className="text-sm text-gray-600 flex items-center">
                          <Clock className="w-4 h-4 text-gray-500 mr-2" />
                          {formData.availableTimeStart && formData.availableTimeEnd ? (
                            <span>
                              {formData.availableTimeStart} to {formData.availableTimeEnd}
                            </span>
                          ) : (
                  ...
                  <div className="flex items-start">
                    ...
                    <label htmlFor="terms" className="text-sm text-gray-600">
                      ...
                      MediSeek.ai's <a href="#" className="text-blue-600 hover:underline">Terms of Service</a> and{' '}
